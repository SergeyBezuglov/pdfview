...
namespace PIMS.Application.Authentication.Queries.Forms
{
        ...
        IRequestHandler<LoginQuery, ErrorOr<AuthenticationResult>>
    {
        ...
        /// <summary>
        /// Обрабатывает запрос на вход пользователя, проверяет правильный ли пароль указал пользователь, генерирует токен JWT и возвращает результат аутентификации (AuthenticationResult).
        /// </summary>
